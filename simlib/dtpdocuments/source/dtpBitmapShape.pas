...
uses
  ...
  dtpGraphics, RelaxXml, dtpDefaults, sdWidestrings, dtpMemoShape,
...
procedure TdtpBitmapShape.LoadFromXml(ANode: TXmlNode);
var
  Child: TXmlNode;
begin
  inherited;
...
procedure TdtpBitmapShape.SaveToXml(ANode: TXmlNode);
begin
  inherited;
