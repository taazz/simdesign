...
type
  ...
  TdtpFilingEvent = procedure (Sender: TObject; Node: TXmlNode) of object;
  TdtpShapeFilingEvent = procedure (Sender: TObject; Shape: TdtpShape; Node: TXmlNode) of object;
  ...
  protected
    ...
    procedure DoShapeLoadAdditionalInfo(Shape: TdtpShape; Node: TXmlNode);
    procedure DoShapeNudge(const Key: word);  //  added by J.F. June 2011
    procedure DoShapeSaveAdditionalInfo(Shape: TdtpShape; Node: TXmlNode);
...
procedure TdtpDocument.DoShapeLoadAdditionalInfo(Shape: TdtpShape; Node: TXmlNode);
begin
...
procedure TdtpDocument.DoShapeSaveAdditionalInfo(Shape: TdtpShape; Node: TXmlNode);
begin
...
procedure TdtpDocument.LoadFromXml(ANode: TXmlNode);
var
  ChildNode: TXmlNode;
  BM: TdtpBitmap;
begin
...
procedure TdtpDocument.SaveToXml(ANode: TXmlNode);
begin
  if not assigned(ANode) then
    exit;
