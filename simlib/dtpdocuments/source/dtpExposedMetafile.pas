...
uses
  Classes, Windows, Graphics, SysUtils, dtpShape, RelaxXml, dtpXmlBitmaps,
...
procedure TdtpExposedMetafile.LoadFromXml(ANode: TXmlNode);
var
  ABitmap: TBitmap;
begin
  inherited;
...
procedure TdtpExposedMetafile.SaveToXml(ANode: TXmlNode);
begin
  inherited;
