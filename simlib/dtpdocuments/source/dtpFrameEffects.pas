...
uses
  dtpShape, dtpEffectShape, Graphics, dtpGraphics, Math, dtpUtil, RelaxXml;
...
procedure TdtpFrameEffect.LoadFromXml(ANode: TXmlNode);
begin
  inherited;
...
procedure TdtpFrameEffect.SaveToXml(ANode: TXmlNode);
begin
  inherited;
