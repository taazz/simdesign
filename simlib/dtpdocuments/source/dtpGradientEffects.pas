...
uses
  ...
  RelaxXml, dtpUtil, dtpGraphics, dtpStretch, dtpDefaults;
...
procedure SavePaletteToXml(ANode: TXmlNode; const FPalette: TdtpGradientPalette);

// Load a gradient palette from an XML node
procedure LoadPaletteFromXml(ANode: TXmlNode; var FPalette: TdtpGradientPalette);
...
procedure TdtpColorStopList.LoadFromXml(ANode: TXmlNode);
...
procedure TdtpColorStopList.SaveToXml(ANode: TXmlNode);
...
procedure TdtpGradientEffect.LoadFromXml(ANode: TXmlNode);
var
  i: integer;
  Name: string;
begin
...
procedure TdtpGradientEffect.SaveToXml(ANode: TXmlNode);
begin
  inherited;
...
procedure TdtpReplacementEffect.LoadFromXml(ANode: TXmlNode);
begin
  inherited;
...
procedure TdtpReplacementEffect.SaveToXml(ANode: TXmlNode);
begin
  inherited;
