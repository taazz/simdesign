...
uses
  ...
  Classes, SysUtils, Contnrs, dtpEffectShape, dtpBitmapResource, RelaxXml,
...
type
  ...
  public
    ...
    procedure LoadFromXml(ANode: TXmlNode); virtual;
    procedure SaveToXml(ANode: TXmlNode); virtual;
...
procedure LoadFontStyle(ANode: TXmlNode; var Style: TFontStyles);
begin
  Style := [];
...
procedure SaveFontStyle(ANode: TXmlNode; const Style: TFontStyles);
begin
...
procedure TdtpMaskEffect.LoadFromXml(ANode: TXmlNode);
var
  i: integer;
  AList: TList;
  AChild: TXmlNode;
...
procedure TdtpMaskEffect.SaveToXml(ANode: TXmlNode);
var
  i: integer;
  AChild: TXmlNode;
begin
...
procedure TdtpMask.LoadFromXml(ANode: TXmlNode);
begin
...
procedure TdtpMask.SaveToXml(ANode: TXmlNode);
begin
...
procedure TdtpFeatherMask.LoadFromXml(ANode: TXmlNode);
begin
  inherited;
...
procedure TdtpFeatherMask.SaveToXml(ANode: TXmlNode);
begin
  inherited;
...
procedure TdtpPositionMask.LoadFromXml(ANode: TXmlNode);
begin
  inherited;
...
procedure TdtpPositionMask.SaveToXml(ANode: TXmlNode);
begin
  inherited;
...
procedure TdtpBitmapMask.LoadFromXml(ANode: TXmlNode);
begin
  inherited;
...
procedure TdtpBitmapMask.SaveToXml(ANode: TXmlNode);
begin
  inherited;
...
procedure TdtpPolygonMask.LoadFromXml(ANode: TXmlNode);
begin
  inherited;
...
procedure TdtpPolygonMask.SaveToXml(ANode: TXmlNode);
begin
  inherited;
