...
uses
  Classes, Contnrs, Windows, SysUtils, SyncObjs, RelaxXml,
...
type
  ...
  private
    ...
    procedure LoadFromEmbedded(ANode: TXmlNode);
    procedure SaveToArchive;
    procedure SaveToEmbedded(ANode: TXmlNode);
...
procedure TdtpResource.LoadFromEmbedded(ANode: TXmlNode);
// Load the stream from the embedded XML format in FNode
var
  AData, ABuffer: TXmlNode;
...
procedure TdtpResource.LoadFromXML(ANode: TXmlNode);
var
...
procedure TdtpResource.SaveToEmbedded(ANode: TXmlNode);
...
procedure TdtpResource.SaveToXml(ANode: TXmlNode);
begin
  BeginAccess;
  try
