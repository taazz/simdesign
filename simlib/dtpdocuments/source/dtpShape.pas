...
uses
  ...
  dtpHandles, dtpTransform, dtpSampler, RelaxXml, sdStorage, sdDebug;
...
type
  ...
  public
    ...
    constructor CreateFromXml(ANode: TXmlNode); virtual;
...
constructor TdtpShape.CreateFromXml(ANode: TXmlNode);
begin
  Create;
  LoadFromXml(ANode);
end;
...
procedure TdtpShape.LoadFromXml(ANode: TXmlNode);
var
  i: integer;
  SC: TdtpShapeClass;
  Shape: TdtpShape;
...
procedure TdtpShape.SaveToXml(ANode: TXmlNode);
var
  i: integer;
  Child: TXmlNode;
begin
