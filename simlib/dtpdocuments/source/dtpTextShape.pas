...
uses
  ...
  dtpGraphics, dtpLineEdit, RelaxXml, dtpEffectShape,
...
procedure TdtpTextBaseShape.LoadFromXml(ANode: TXmlNode);
var
  i: integer;
  AChild: TXmlNode;
  AList: TXmlNodeList;
...
procedure TdtpTextBaseShape.SaveToXml(ANode: TXmlNode);
var
  i: integer;
  Sub: TXmlNode;
begin
...
procedure TdtpTextSpan.LoadFromXml(ANode: TXmlNode);
begin
...
procedure TdtpTextSpan.SaveToXml(ANode: TXmlNode);
begin
