...
uses
  ...
  dtpDefaults, dtpUtil, dtpGraphics, RelaxXml, Math;
...
procedure TdtpTextureEffect.LoadFromXml(ANode: TXmlNode);
begin
  inherited;
...
procedure TdtpTextureEffect.SaveToXml(ANode: TXmlNode);
begin
  inherited;
