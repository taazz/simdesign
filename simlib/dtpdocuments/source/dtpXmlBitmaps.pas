...
uses
  Classes, Graphics, dtpGraphics, RelaxXml, sdCompressors;

// Read / write a TBitmap from / to an XML node
procedure XmlReadBitmap(ANode: TXmlNode; const AName: Utf8String; var ABitmap: TBitmap);
procedure XmlWriteBitmap(ANode: TXmlNode; const AName: Utf8String; ABitmap: TBitmap);

// Read / write a TBitmap32 from / to an XML node
procedure XmlReadBitmap32(ANode: TXmlNode; const AName: Utf8String; var ABitmap: TdtpBitmap);
procedure XmlWriteBitmap32(ANode: TXmlNode; const AName: Utf8String; ABitmap: TdtpBitmap);

// Read / write a TMemoryStream from / to an XML node using RLE compression
procedure XmlReadRLEStream(ANode: TXmlNode; const AName: Utf8String; AStream: TMemoryStream);
procedure XmlWriteRLEStream(ANode: TXmlNode; const AName: Utf8String; AStream: TMemoryStream);

// Read / write a TMemoryStream from / to an XML node using HCK compression
procedure XmlReadHCKStream(ANode: TXmlNode; const AName: Utf8String; AStream: TMemoryStream);
procedure XmlWriteHCKStream(ANode: TXmlNode; const AName: Utf8String; AStream: TMemoryStream);

// Write buffer memory to an XML node using HCK compression
procedure XmlWriteHCKBuf(ANode: TXmlNode; const AName: Utf8String; ASource: Pointer; ASourceSize: integer);
