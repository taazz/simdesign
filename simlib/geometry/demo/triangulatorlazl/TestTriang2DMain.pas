...
begin
  FGraph.Boundarys.Add(TsdBoundary2D.CreateWithVertices(V1, V2))
end;
...
begin
  ...
  begin
    ...
    if assigned(FPrevVertex) then
      FGraph.Boundarys.Add(TsdBoundary2D.CreateWithVertices(FPrevVertex, Vertex));
...
begin
  ...
  begin
    for i := 0 to FGraph.Boundarys.Count - 1 do
    begin
      P1 := FGraph.Boundarys[i].Vertex1.Point^;
      P2 := FGraph.Boundarys[i].Vertex2.Point^;
...
begin
  ...
  begin
    FGraph.Boundarys.Add(TsdBoundary2D.CreateWithVertices(FPrevVertex, FFirstVertex));
    FFirstVertex := nil;
    FPrevVertex := nil;
    mnuClosePolygon.Enabled := False;
  end;
