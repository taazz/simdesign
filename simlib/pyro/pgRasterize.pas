...
uses
  ...
  pgCover, pgTransform, pgPolygon, Pyro;
...
type
  ...
  public
    ...
    // ATransform (if given).
    procedure RasterizePolyPolygon(APolyPolygon: TpgPolyPolygon; ATransform: TpgTransformList);
    // Rasterize a closed polygon in APolygon, transform the points first by
    // ATransform (if given).
    procedure RasterizePolygon(APolygon: TpgPolygon; ATransform: TpgTransformList);
...
procedure TpgRasterizer.RasterizePolygon(APolygon: TpgPolygon; ATransform: TpgTransformList);
begin
// todo
...
begin
  ...
  begin
    ...
    ATransform.TransformPoints(APolyPolygon.FirstPoint, @FPoints[0],
