...
type
  ...
  private
    ...
    function SegmentViolated(ASegment: TsdSegment2D; AVertex: TsdVertex2D): boolean;
...
function TsdConvexHull.SegmentViolated(ASegment: TsdSegment2D; AVertex: TsdVertex2D): boolean;
begin
