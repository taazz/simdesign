...
uses
  Windows, Classes, ExtCtrls, Graphics, SysUtils, NativeJpg,
...
type
  ...
  protected // NH: must change this to "protected" for descendant types
    FProgressRect: TRect;
...
initialization
  ...
  begin
    ...
    RegisterFileFormat('jfif', gesJPGImages, gesJFIFImages, [ftRaster], False, False, TsdJpegGraphic);
    RegisterFileFormat('jpg', '', gesJPGImages, [ftRaster], False, False, TsdJpegGraphic);
    RegisterFileFormat('jpe', '', gesJPEImages, [ftRaster], False, False, TsdJpegGraphic);
    RegisterFileFormat('jpeg', '', gesJPEGImages, [ftRaster], False, False, TsdJpegGraphic);
