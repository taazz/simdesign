...
// (DO NOT EDIT: machine generated header) 'Virtualtrees.pas' rev: 10.00
...
#pragma option push -b-
enum TVTColumnOption { coAllowClick, coDraggable, coEnabled, coParentBidiMode, coParentColor, coResizable, coShowDropMark, coVisible, coAutoSpring, coFixed };
#pragma option pop

typedef Set<TVTColumnOption, coAllowClick, coFixed>  TVTColumnOptions;
...
#pragma option push -b-
enum TVTAutoOption { toAutoDropExpand, toAutoExpand, toAutoScroll, toAutoScrollOnExpand, toAutoSort, toAutoSpanColumns, toAutoTristateTracking, toAutoHideButtons, toAutoDeleteMovedNodes, toDisableAutoscrollOnFocus, toAutoChangeScale, toAutoFreeOnCollapse, toDisableAutoscrollOnEdit };
#pragma option pop

typedef Set<TVTAutoOption, toAutoDropExpand, toDisableAutoscrollOnEdit>  TVTAutoOptions;
...
protected:
	...
	void __fastcall HandleClick(const Types::TPoint &P, Controls::TMouseButton Button, bool Force, bool DblClick);
...
public:
	...
	bool __fastcall Equals(TVirtualTreeColumns* OtherColumns);
	void __fastcall GetColumnBounds(TColumnIndex Column, int &Left, int &Right);
	TColumnIndex __fastcall GetFirstVisibleColumn(void);
	TColumnIndex __fastcall GetLastVisibleColumn(void);
	TColumnIndex __fastcall GetNextColumn(TColumnIndex Column);
	TColumnIndex __fastcall GetNextVisibleColumn(TColumnIndex Column);
	TColumnIndex __fastcall GetPreviousColumn(TColumnIndex Column);
	TColumnIndex __fastcall GetPreviousVisibleColumn(TColumnIndex Column);
...
#pragma option push -b-
enum TVTHeaderOption { hoAutoResize, hoColumnResize, hoDblClickResize, hoDrag, hoHotTrack, hoOwnerDraw, hoRestrictDrag, hoShowHint, hoShowImages, hoShowSortGlyphs, hoVisible, hoAutoSpring };
#pragma option pop

typedef Set<TVTHeaderOption, hoAutoResize, hoAutoSpring>  TVTHeaderOptions;
...
public:
	...
	virtual void __fastcall Assign(Classes::TPersistent* Source);
	void __fastcall AutoFitColumns(bool Animated = true);
	virtual bool __fastcall InHeader(const Types::TPoint &P);
	void __fastcall Invalidate(TVirtualTreeColumn* Column, bool ExpandToRight = false);
...
#pragma option push -b-
enum VirtualTrees__61 { tsCancelHintAnimation, tsChangePending, tsCheckPropagation, tsCollapsing, tsToggleFocusedSelection, tsClearPending, tsClipboardFlushing, tsCopyPending, tsCutPending, tsDrawSelPending, tsDrawSelecting, tsEditing, tsEditPending, tsExpanding, tsHint, tsInAnimation, tsIncrementalSearching, tsIncrementalSearchPending, tsIterating, tsKeyCheckPending, tsLeftButtonDown, tsMouseCheckPending, tsMiddleButtonDown, tsNeedScale, tsNeedRootCountUpdate, tsOLEDragging, tsOLEDragPending, tsPainting, tsRightButtonDown, tsPopupMenuShown, tsScrolling, tsScrollPending, tsSizing, tsStopValidation, tsStructureChangePending, tsSynchMode, tsThumbTracking, tsUpdateHiddenChildrenNeeded, tsUpdating, tsUseCache, tsUserDragObject, tsUseThemes, tsValidating, tsValidationNeeded, tsVCLDragging, tsVCLDragPending, tsWheelPanning, tsWheelScrolling, tsWindowCreating };
#pragma option pop
...
typedef void __fastcall (__closure *TVTBeforeCellPaintEvent)(TBaseVirtualTree* Sender, Graphics::TCanvas* TargetCanvas, PVirtualNode Node, TColumnIndex Column, const Types::TRect &CellRect);
...
protected:
	...
	virtual void __fastcall DoBeforeCellPaint(Graphics::TCanvas* Canvas, PVirtualNode Node, TColumnIndex Column, const Types::TRect &CellRect);
	...
	#pragma option push -w-inl
	/* virtual class method */ virtual Imglist::TCustomImageList* __fastcall GetCheckImageListFor(TCheckImageKind Kind) { return GetCheckImageListFor(__classid(TBaseVirtualTree), Kind); }
	#pragma option pop
	/*         class method */ static Imglist::TCustomImageList* __fastcall GetCheckImageListFor(TMetaClass* vmt, TCheckImageKind Kind);
...
public:
	...
	Types::TRect __fastcall GetDisplayRect(PVirtualNode Node, TColumnIndex Column, bool TextOnly, bool Unclipped = false);
	PVirtualNode __fastcall GetFirst(void);
	PVirtualNode __fastcall GetFirstChecked(TCheckState State);
	...
	void __fastcall GetHitTestInfoAt(int X, int Y, bool Relative, THitInfo &HitInfo);
	...
	int __fastcall GetMaxColumnWidth(TColumnIndex Column);
	...
	bool __fastcall ScrollIntoView(PVirtualNode Node, bool Center, bool Horizontally = false);
...
public:
	...
	virtual void __fastcall Assign(Classes::TPersistent* Source);
	virtual bool __fastcall Equals(TVirtualTreeColumn* OtherColumn);
...
__published:
	...
	__property TVTColumnOptions Options = {read=FOptions, write=SetOptions, default=255};
...
typedef void __fastcall (__closure *TVSTShortenStringEvent)(TBaseVirtualTree* Sender, Graphics::TCanvas* TargetCanvas, PVirtualNode Node, TColumnIndex Column, const WideString S, int TextSpace, bool RightToLeft, WideString &Result, bool &Done);
...
protected:
	...
	virtual WideString __fastcall DoShortenString(Graphics::TCanvas* Canvas, PVirtualNode Node, TColumnIndex Column, const WideString S, int Width, bool RightToLeft, int EllipsisWidth = 0x0);
...
protected:
	void __fastcall AutoAdjustSize(void);
	virtual void __fastcall CreateParams(Controls::TCreateParams &Params);
...
//-- var, const, procedure ---------------------------------------------------
#define VTVersion "4.4.3"
static const Shortint VTTreeStreamVersion = 0x2;
static const Shortint VTHeaderStreamVersion = 0x3;
...
static const Controls::TCursor crHeaderSplit = 100;
...
#define DefaultAutoOptions (Set<TVTAutoOption, toAutoDropExpand, toDisableAutoscrollOnEdit> () << TVTAutoOption(0) << TVTAutoOption(3) << TVTAutoOption(6) << TVTAutoOption(8) )
...
#define DefaultColumnOptions (Set<TVTColumnOption, coAllowClick, coFixed> () << TVTColumnOption(0) << TVTColumnOption(1) << TVTColumnOption(2) << TVTColumnOption(3) << TVTColumnOption(4) << TVTColumnOption(5) << TVTColumnOption(6) << TVTColumnOption(7) )
...
extern PACKAGE WideString __fastcall ShortenString(HDC DC, const WideString S, int Width, bool RTL, int EllipsisWidth = 0x0);
