...
procedure TdtpBrightContrEffect.LoadFromXml(ANode: TXmlNode);
begin
  inherited;
...
procedure TdtpBrightContrEffect.SaveToXml(ANode: TXmlNode);
begin
  inherited;
...
procedure TdtpHSLAdjustEffect.LoadFromXml(ANode: TXmlNode);
begin
  inherited;
...
procedure TdtpHSLAdjustEffect.SaveToXml(ANode: TXmlNode);
begin
  inherited;
...
procedure TdtpSepiaEffect.LoadFromXml(ANode: TXmlNode);
begin
  inherited;
  FDepth := ANode.ReadInteger('Depth');
end;

procedure TdtpSepiaEffect.SaveToXml(ANode: TXmlNode);
begin
  inherited;
