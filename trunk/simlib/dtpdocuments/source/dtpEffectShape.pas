...
uses
  Classes, Contnrs, ExtCtrls, StdCtrls, SysUtils, dtpShape, dtpCommand, RelaxXml,
...
procedure TdtpEffect.LoadFromXml(ANode: TXmlNode);
...
procedure TdtpEffect.SaveToXml(ANode: TXmlNode);
begin
  if not assigned(ANode) then
    exit;
...
procedure TdtpEffectShape.LoadFromXml(ANode: TXmlNode);
var
  i: integer;
  List: TList;
  Child: TXmlNode;
...
procedure TdtpEffectShape.SaveToXml(ANode: TXmlNode);
var
  i: integer;
  Child: TXmlNode;
begin
