...
uses
  ...
  dtpPolygonShape, RelaxXml, Controls, dtpHandles;
...
procedure TdtpLineShape.LoadFromXml(ANode: TXmlNode);
var
  i: integer;
  AChild: TXmlNode;
  AList: TList;
...
begin
  ...
  begin
    ...
    try
      ...
      begin
        APoint.X := TXmlNode(AList[i]).ReadFloat('X');
        APoint.Y := TXmlNode(AList[i]).ReadFloat('Y');
        PointAdd(APoint);
      end;
    finally
      AList.Free;
...
procedure TdtpLineShape.SaveToXml(ANode: TXmlNode);
var
  i: integer;
begin
...
procedure TdtpArrow.LoadFromXml(ANode: TXmlNode);
var
  i: integer;
  AName: string;
begin
...
procedure TdtpArrow.SaveToXml(ANode: TXmlNode);
begin
