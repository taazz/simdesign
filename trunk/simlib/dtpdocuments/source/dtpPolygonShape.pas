...
uses
  ...
  SysUtils, Graphics, Math, RelaxXml, Classes, dtpShape, ExtCtrls,
...
procedure TdtpPolygonShape.LoadFromXml(ANode: TXmlNode);
var
  i, j: integer;
  ALines, APoints: TList;
  X, Y: single;
  Sub1, Sub2, Sub3: TXmlNode;
begin
  inherited;
  // Props
...
procedure TdtpPolygonShape.SaveToXml(ANode: TXmlNode);
var
  i, j: integer;
  Sub1, Sub2, Sub3: TXmlNode;
begin
...
procedure TdtpRoundRectShape.LoadFromXml(ANode: TXmlNode);
begin
  inherited;
...
procedure TdtpRoundRectShape.SaveToXml(ANode: TXmlNode);
begin
  inherited;
