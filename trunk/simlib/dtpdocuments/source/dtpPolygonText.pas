...
uses
  ...
  dtpEffectShape, dtpTextShape, dtpCommand, dtpShape, dtpDefaults, RelaxXml,
...
procedure TdtpTransformText.LoadFromXml(ANode: TXmlNode);
begin
  inherited;
  TransformMethod := TTransformMethod(ANode.ReadInteger('TransformMethod'));
end;

procedure TdtpTransformText.SaveToXml(ANode: TXmlNode);
begin
  inherited;
...
procedure TdtpCurvedText.LoadFromXml(ANode: TXmlNode);
begin
  inherited;
...
procedure TdtpCurvedText.SaveToXml(ANode: TXmlNode);
begin
  inherited;
...
procedure TWaveTransform.LoadFromXml(ANode: TXmlNode);
begin
...
procedure TWaveTransform.SaveToXml(ANode: TXmlNode);
begin
...
procedure TdtpWavyText.LoadFromXml(ANode: TXmlNode);
var
  AChild: TXmlNode;
begin
  inherited;
...
procedure TdtpWavyText.SaveToXml(ANode: TXmlNode);
var
  AChild: TXmlNode;
begin
  inherited;
