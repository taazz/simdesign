 ...
 **********************************************************************}
 // adaptions mellobot (mellobot@gmail.com)
{$h+}
unit Process;

interface

uses Windows, Classes, Pipes, SysUtils;
...
function RunCommandIndir(const curdir:string;const exename:string;const commands:array of string;var outputstring:string;var exitstatus:integer):integer; overload; 
function RunCommandIndir(const curdir:string;const exename:string;const commands:array of string;var outputstring:string):boolean; overload;
function RunCommandInDir(const curdir,cmdline:string;var outputstring:string):boolean; overload;//deprecated

function RunCommand(const exename:string;const commands:array of string;var outputstring:string):boolean; overload;
