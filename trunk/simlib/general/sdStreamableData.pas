...
procedure StreamReadCardinal(S: TStream; var Value: cardinal);
procedure StreamWriteCardinal(S: TStream; Value: cardinal);

procedure StreamReadInteger(S: TStream; var Value: longint);
procedure StreamWriteInteger(S: TStream; Value: longint);

procedure StreamReadInt64(S: TStream; var Value: int64);
procedure StreamWriteInt64(S: TStream; Value: int64);
...
procedure StreamReadCardinal(S: TStream; var Value: cardinal);
begin
  S.ReadBuffer(Value, SizeOf(cardinal));
end;

procedure StreamWriteCardinal(S: TStream; Value: cardinal);
begin
  S.WriteBuffer(Value, SizeOf(cardinal));
end;
...
procedure StreamReadInt64(S: TStream; var Value: int64);
begin
  S.ReadBuffer(Value, SizeOf(int64));
end;

procedure StreamWriteInt64(S: TStream; Value: int64);
begin
  S.WriteBuffer(Value, SizeOf(int64));
end;
