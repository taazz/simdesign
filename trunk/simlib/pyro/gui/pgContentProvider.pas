...
type
  ...
  protected
    ...
    // The TpgCustomControl that we're associated with
    property Associate: TpgCustomControl read FAssociate;

  public
    constructor Create(AOwner: TComponent); override;
    destructor Destroy; override;
    // Called by the associate to set itself
    procedure SetAssociate(const Value: TpgCustomControl);
...
procedure TpgContentProvider.SetAssociate(const Value: TpgCustomControl);
begin
  FAssociate := Value;
